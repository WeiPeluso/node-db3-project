...
- Add the following method to your API
  ...
  - You may use `POST /api/schemes/:id/addStep` to test this method.
    ...
    Solution :
    select c.CategoryName, count(p.ProductName) as Count from Category as c
    ...
    2, Display OrderID and a column called ItemCount that shows the total number of products placed on the order. Shows 196 records.
     Solution:
        select o.id , sum(od.Quantity) from [order] as o join orderDetail as od
        on o.Id=od.OrderId group by o.id limit(196);
